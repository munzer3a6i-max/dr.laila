...
(function () {
  ...
  var DICT = {
    ...
    ar: {
      ...
      'about.p1': 'بدأت العمل في جامعة المجمعة عام 1433هـ، وأتولى اليوم إدارة مركز تنمية المهارات والقيم الطلابية في عمادة شؤون الطلاب. وإلى جانب ذلك أعمل مستشارة أسرية وتربوية ومدربة معتمدة، أرافق الأسر وأبناءها في مسائل التربية والتواصل والصحة النفسية.',
      'about.p2': 'قدّمت أكثر من مئة دورة تدريبية لجهات حكومية وخاصة وغير ربحية في القيادة الأسرية والصحة النفسية ومهارات التفكير، وأسهمت في تأسيس مركز التدريب المجتمعي النسوي بالزلفي وإدارته ثلاث سنوات. وقد نلت جائزة معالي مدير جامعة المجمعة للجودة والتميز مرتين، وجائزة التطوع من مركز العمل التطوعي بالجامعة.',
      'about.cred1': 'بكالوريوس علم النفس',
      'about.cred1sub': 'كليات عنيزة الأهلية',
      'about.cred2': 'دبلوم المستشار الأسري والتربوي',
      'about.cred2sub': 'أكاديمية الشرق الأوسط للتدريب والتطوير',
      'about.cred3': 'دبلوم الكوتشينج الدولي',
      'about.cred3sub': 'أكاديمية IDU للأعمال والتدريب',
      'about.cred4': 'مدربة معتمدة',
      'about.cred4sub': 'المؤسسة العامة للتدريب التقني والمهني ووزارة التعليم',
      'about.cvView': 'عرض السيرة الذاتية',
      'about.cvDownload': 'تحميل PDF',
      'about.name': 'د. دلال العصيمي',
      'about.role': 'مستشارة أسرية وتربوية · مدربة معتمدة',
      ...
      'booking.childLabel': 'اسم الطفل وعمره (اختياري)',
      'booking.childPh': 'مها ، 6 سنوات',
      'booking.emailLabel': 'البريد الالكتروني',
      'booking.waLabel': 'رقم الواتساب',
      'booking.waPh': '05xxxxxxxx',
      'booking.waHint': 'سنتواصل معك على هذا الرقم لترتيب الدفع',
      ...
      'booking.submitNote': 'سنتواصل معك عبر الواتساب لترتيب الدفع وتأكيد الموعد',
      'booking.doneTitle': 'تم استلام طلبك',
      'booking.doneNote': 'موعدك محجوز مبدئيًا. سنتواصل معك عبر الواتساب خلال 24 ساعة لترتيب الدفع، ويُثبَّت الحجز نهائيًا بعد إتمامه.',
      ...
      'bk.typeUnavailable': 'هذا النوع من الجلسات غير متاح للحجز حالياً. الرجاء اختيار نوع آخر أو التواصل معنا مباشرة.',
      'bk.taken': 'محجوز',
      ...
      'bk.errWhatsapp': 'الرجاء إدخال رقم واتساب صحيح.',
    ...
    en: {
      ...
      'about.p1': 'I joined Majmaah University in 1433 AH and today I direct the Student Skills and Values Development Centre in the Deanship of Student Affairs. Alongside that I work as a family and educational counsellor and a certified trainer, walking with families and their children through questions of parenting, communication and mental wellbeing.',
      'about.p2': 'I have delivered more than a hundred training courses for government, private and non-profit bodies on family leadership, mental wellbeing and thinking skills, and I helped found the Women\'s Community Training Centre in Al-Zulfi and ran it for three years. I have twice received the Majmaah University Rector\'s Award for Quality and Excellence, and the Volunteering Award from the university\'s Volunteer Work Centre.',
      'about.cred1': 'BSc in Psychology',
      'about.cred1sub': 'Unaizah Private Colleges',
      'about.cred2': 'Diploma, Family & Educational Counselling',
      'about.cred2sub': 'Middle East Academy for Training and Development',
      'about.cred3': 'International Coaching Diploma',
      'about.cred3sub': 'IDU Academy for Business and Training',
      'about.cred4': 'Certified trainer',
      'about.cred4sub': 'Technical and Vocational Training Corporation, and the Ministry of Education',
      'about.cvView': 'View CV',
      'about.cvDownload': 'Download PDF',
      'about.name': 'Dr. Dalal Al-Osaimy',
      'about.role': 'Family & educational counsellor · Certified trainer',
      ...
      'booking.childLabel': 'Child’s name and age (optional)',
      'booking.childPh': 'Maha, 6 years old',
      'booking.emailLabel': 'Email address',
      'booking.waLabel': 'WhatsApp number',
      'booking.waPh': '05xxxxxxxx',
      'booking.waHint': 'We will reach you on this number to arrange payment',
      ...
      'booking.submitNote': 'We will contact you on WhatsApp to arrange payment and confirm the time',
      'booking.doneTitle': 'Request received',
      'booking.doneNote': 'Your slot is held. We will message you on WhatsApp within 24 hours to arrange payment, and the booking is confirmed once that is done.',
      ...
      'bk.typeUnavailable': 'This session type is not open for booking yet. Please choose another, or contact us directly.',
      'bk.taken': 'booked',
      ...
      'bk.errWhatsapp': 'Please enter a valid WhatsApp number.',
